...
//     } else {
//       await setDoc(docRef, { quantity: newQty })
//     }
...
//       await setDoc(docRef, { quantity: quantity + 1 })
//     } else {
//       await setDoc(docRef, { quantity: 1, description: '' }) // Ensure description field is present
//     }
//     await updateInventory()
//   }
...
//   const openDescriptionModal = async (item) => {
//     setCurrentItem(item)
//     const docRef = doc(collection(firestore, 'inventory'), item)
//     const docSnap = await getDoc(docRef)
//     if (docSnap.exists()) {
...
//             Edit Description for {currentItem}
//           </Typography>
//           <TextField
...
//                   Remove
//                 </Button>
//                 <IconButton onClick={() => openDescriptionModal(name)}>
//                   <DescriptionIcon />
//                 </IconButton>
//               </Stack>
//             </Box>
